...
import Svg, { Circle, Path, SvgProps, Polygon, Rect } from "react-native-svg";

export default function LockSvg(props: SvgProps) {
  const { colors } = useTheme();

  return (
    <Svg data-name="Layer 1" width="866.52362" height="637.05628" viewBox="0 0 866.52362 637.05628" {...props}>
      <Path
      ...
      <Path
        ...
        fill="#e5e5e5"
      />
      <Rect x="279.40817" y="244.69464" width="191.03421" height="9.03209" fill={colors.primary} />
      <Rect x="279.40817" y="268.17807" width="191.03421" height="9.03209" fill={colors.primary} />
      <Rect x="279.40817" y="291.66149" width="191.03421" height="9.03209" fill={colors.primary} />
      <Circle cx="263.87741" cy="250.53394" r="5.89453" fill={colors.primary} />
      ...
      <Circle cx="515.67691" cy="438.20509" r="68.29339" fill={colors.primary} />
      <Path
